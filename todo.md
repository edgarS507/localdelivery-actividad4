# TODO — Actividad 5: AulaTrack

- [x] Revisar la guía PDF y extraer requisitos funcionales, técnicos y de entrega.
- [x] Confirmar el alcance de continuidad desde la Actividad 4 hacia AulaTrack.
- [x] Definir arquitectura cliente-servidor y modelo de datos.
- [x] Implementar API o lógica de servidor requerida por la guía.
- [x] Integrar el frontend AulaTrack con el servidor.
- [x] Añadir validaciones, manejo de errores y estados de carga.
